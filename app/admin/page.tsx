            ...
            <div className="max-h-[65vh] overflow-auto">
              <div className="space-y-2 p-3 lg:hidden">
                {filteredRows.map((row, idx) => (
                  <div key={`${row.nickname_key}-${row.updated_at}-card`} className="rounded-lg border border-[#f4d5e4] bg-[#fffafd] p-2.5">
                    <div className="mb-1 inline-flex rounded-full border border-[#f0bfd8] bg-white px-1.5 py-0.5 text-[10px] font-black text-[#960953]">
                      Rank #{idx + 1}
                    </div>
                    <p className="truncate text-sm font-black text-[#4e1434]">{row.nickname_display}</p>
                    <p className="truncate text-[11px] font-semibold text-[#8d6280]">{row.nickname_key}</p>
                    <div className="mt-1.5 grid grid-cols-2 gap-1.5 text-[11px] font-semibold text-[#6a3b58]">
                    ...
                    <div className="mt-2 text-right">
                      <button
                        ...
                        className="rounded-md border border-[#d94b77] bg-[#ffe9f1] px-2.5 py-1 text-[11px] font-black text-[#b31d53] disabled:opacity-60"
                      >
